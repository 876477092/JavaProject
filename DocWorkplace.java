...
public class DocWorkplace extends JFrame {
	...
	public DocWorkplace() {
		SQL sql=new SQL();
		final Doctor doctor=Doctor("10001",sql);
		...
		JLabel mid2 = new JLabel(doctor.getUser().getMID());
		mid2.setBounds(22, 78, 184, 18);
		p1.add(mid2);
		
		JLabel id2 = new JLabel(doctor.getUser().getID());
		...
		JLabel name2 = new JLabel(doctor.getUser().getName());
		name2.setBounds(22, 190, 72, 18);
		p1.add(name2);
		
		sex2 = new JLabel(doctor.getUser().getSex());
		sex2.setBounds(22, 246, 72, 18);
		p1.add(sex2);
		
		String age=Integer.toString(doctor.getUser().getAge());
		JLabel age2 = new JLabel(age);
		age2.setBounds(22, 302, 72, 18);
		p1.add(age2);
		
		JLabel type2 = new JLabel(doctor.getUser().getDeptid());
		...
		final JComboBox select2 = new JComboBox();
		...
		JLabel spec2 = new JLabel(doctor.seacherSpec(select2.getSelectedItem().toString()));
		...
		medname2.addActionListener(new ActionListener(){
			public  void actionPerformed(ActionEvent event){
				
				try {
					String[] m = doctor.seacherMed(medname1.getText());
		...
		final JTextArea med2 = new JTextArea();
		med2.setEditable(false);
		med2.setLineWrap(true);
		med2.setBounds(34, 245, 348, 85);
		p2.add(med2);
		
		final JTextArea item2 = new JTextArea();
		item2.setLineWrap(true);
		item2.setBounds(34, 360, 348, 85);
		p2.add(item2);
		
		JButton btnTijiap = new JButton("提交");
		btnTijiap.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		btnTijiap.setForeground(new Color(255, 255, 255));
		btnTijiap.setBackground(new Color(178, 34, 34));
		btnTijiap.setBounds(459, 558, 84, 33);
		getContentPane().add(btnTijiap);
		...
		itemname2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String m = doctor.seacherChargeitem(itemname1.getText());
		...
		button_3.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event){
				item2.append(comboBox_1.getSelectedItem().toString()+ " ------*");
				item2.append(comboBox_2.getSelectedItem().toString()+"\r\n");
			}
		});
		...
		button_1.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event){
				med2.append(select2.getSelectedItem().toString()+ " ------*");
				med2.append(comboBox.getSelectedItem().toString()+"\r\n");
			}
		});
	...
	private Doctor Doctor(String string, SQL sql) {
